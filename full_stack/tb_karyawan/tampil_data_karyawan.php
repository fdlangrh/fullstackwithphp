                        ...
                        <div class="plc">
                            <div class="input-group mb-3 ">
                                ...
                                <input type="text" class="form-control" placeholder="Cari Data"
                                    aria-label="Tulis Data karyawan" aria-describedby="addon-wrapping" name="kata kunci"
                                    required />
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header bg-primary">
                                <h5 class="modal-title bg-primary text-white" id="exampleModalLongTitle">Tambah Data karyawan</h5>
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control" name="id_karyawan" id="id">
                                            </div>
...
<br>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <label for="id" class="form-label">Alamat karyawan:</label>
                            ...
                            <div class="modal-footer">
                                <a href="tampil_data_karyawan.php">kembali</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-primary" href="#" data-bs-toggle="modal"
                                        data-bs-target="#staticBackdropedit<?php echo $data['id_karyawan']; ?>">
                                        <i class="bi bi-pencil"></i>
                                    </a>

                                    <div class="modal fade" id="staticBackdropedit<?php echo $data['id_karyawan']; ?>"
                                                            ...
                                                            <div class="row">
                                                                <div class="col">
                                                                    ...
                                                                    <input type="hidden" name="id_karyawan"
                                                                        class="form-control"
                                                                        value="<?php echo $data['id_karyawan'] ?>">
                                                                </div>
...
<br>
                    ...
                    <a class="btn btn-danger" href="#" data-bs-toggle="modal"
                        data-bs-target="#staticBackdrophapus<?php echo $data['id_karyawan']; ?>">
                    <i class="bi bi-trash3"></i>
                </a>

                <!-- Modal -->
                <div class="modal fade" id="staticBackdrophapus<?php echo $data['id_karyawan']; ?>" data-bs-backdrop="static"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="proses_hapus_karyawan.php" method="POST">
    ...
    <div class="container">
        <footer class="py-3 my-4">
            <ul class="nav justify-content-center border-bottom pb-3 mb-3">
                <li class="nav-item"><a href="tampil_data_karyawan.php" class="nav-link px-2 text-muted">Home</a></li>
