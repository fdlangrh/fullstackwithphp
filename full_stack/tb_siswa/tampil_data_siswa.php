                        ...
                        <div class="plc">
                            <div class="input-group mb-3 ">
                                ...
                                <input type="text" class="form-control" placeholder="Cari Data"
                                    aria-label="Tulis Data Siswa" aria-describedby="addon-wrapping" name="kata kunci"
                                    required />
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header bg-primary">
                                <h5 class="modal-title bg-primary text-white" id="exampleModalLongTitle">Tambah Data Siswa</h5>
...
<br>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="date" class="form-control" name="tanggal_lahir" id="nik">
                                            </div>
                                        </div>
                                        <br>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <label for="id" class="form-label">Alamat Siswa:</label>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="mb-3">
                                                <div class="form-check form-check-inline">
                                                <input type="radio" class="form-check-input" name="statuspr" id="jk" value="bekerja">
                                                <label for="" class="form-check-label">Bekerja</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                <input type="radio" class="form-check-input" name="statuspr" id="jk" value="belum bekerja">
                            ...
                            <div class="modal-footer">
                                <a href="tampil_data_siswa.php">kembali</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-primary" href="#" data-bs-toggle="modal"
                                        data-bs-target="#staticBackdropedit<?php echo $data['id_siswa']; ?>">
                                        <i class="bi bi-pencil"></i>
                                    </a>

                                    <div class="modal fade" id="staticBackdropedit<?php echo $data['id_siswa']; ?>"
...
<br>
                                          ...
                                          <div class="row mb-3">
                                            ...
                                            <div class="mb-3">
                                                <div class="form-check form-check-inline">
                                                <input type="radio" class="form-check-input" name="statuspr" id="jk" value="bekerja" <?php if ($data['statuspr'] == 'bekerja')
                                                                        echo 'checked' ?>>
                                                <label for="" class="form-check-label">Bekerja</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                <input type="radio" class="form-check-input" name="statuspr" id="jk" value="belum bekerja" <?php if ($data['statuspr'] == 'belum bekerja')
                                                                        echo 'checked' ?>>
                                                <label for="" class="form-check-label">Belum Bekerja</label>
                                            </div>
                                            </div>
                    ...
                    <a class="btn btn-danger" href="#" data-bs-toggle="modal"
                        data-bs-target="#staticBackdrophapus<?php echo $data['id_siswa']; ?>">
                    <i class="bi bi-trash3"></i>
                </a>

                <!-- Modal -->
                <div class="modal fade" id="staticBackdrophapus<?php echo $data['id_siswa']; ?>" data-bs-backdrop="static"
    ...
    <div class="container">
        <footer class="py-3 my-4">
            <ul class="nav justify-content-center border-bottom pb-3 mb-3">
                <li class="nav-item"><a href="tampil_data_siswa.php" class="nav-link px-2 text-muted">Home</a></li>
